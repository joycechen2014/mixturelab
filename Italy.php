		...
		<section class="ftco-section">
			<div class="container">    
				<div class="col-sm-12 text-left"> 
					<h1>Italy</h1>
					<p>Italy (Italian: Italia [iˈtaːlja] (About this soundlisten)), officially the Italian Republic (Italian: Repubblica Italiana [reˈpubblika itaˈljaːna]),[9][10][11][12] is a country in Southern Europe. Located in the middle of the Mediterranean Sea, Italy shares open land borders with France, Switzerland, Austria, Slovenia and the enclaved microstates San Marino and Vatican City. Italy covers an area of 301,340 km2 (116,350 sq mi) and has a largely temperate seasonal and Mediterranean climate. With around 61 million inhabitants, it is the fourth-most populous EU member state and the most populous country in Southern Europe.</p>
					<img class="img-fluid" src="images/Italy.jpg"/>
				</div>
			</div>
		</section>
