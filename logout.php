...
<body>
    ...
    <strong>Logout Successfully!</strong> You can <a href=""  data-toggle="modal" data-target="#modalLoginForm">Sign In</a> here! Or go back to <a href="index.php" >Home Page</a>.
    </div>
