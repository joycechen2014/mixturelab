					...
					<div class="col-lg-12">
						<div class="row">
							<div class="col-md-12 hotel-single mt-4 mb-5 ftco-animate">
								<h2>Go Gene</h2>
								<span><a href="http://www.hzksv.com/"> http://www.hzksv.com/</a></span>
								<p class="rate mb-5">
									<span class="star">
										<i class="icon-star"></i>
										<i class="icon-star"></i>
								...
								<div class="d-md-flex mt-5 mb-5">
									<ul>
										<li><a href="#"><u> cat</u></a></li>
										<li><a href="#"><u>Dog</u></a></li>
										<li><a href="#"><u>Older</u></a></li>
										<li><a href="#"><u>Younger</u></a></li>
									</ul>
									<ul class="ml-md-5">
										<li><a href="#"><u>Men</u></a></li>
										<li><a href="#"><u>Women</u></a></li>
										<li><a href="#"><u>Girl</u></a></li>
										<li><a href="#"><u>Boy</u></a></li>
									</ul>
								</div>
								<p>When she reached the first hills of the Italic Mountains, she had a last view back on the skyline of her hometown Bookmarksgrove, the headline of Alphabet Village and the subline of her own road, the Line Lane. Pityful a rethoric question ran over her cheek, then she continued her way.</p>
							</div>
