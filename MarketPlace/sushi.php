  ...
  <head>
	...
	<body>
	  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark " id="ftco-navbar">
		    <div class="container">
				<a class="navbar-brand" href="index.php" >sushi</a>
				...
				<div class="row">
					<div class="col-lg-12">
						<div class="row">
							<div class="col-md-12 hotel-single mt-4 mb-5 ftco-animate">
								<h2>Sushi</h2>
								<span><a href="http://mataasta.org/homepage.php#"> http://mataasta.org/homepage.php#</a></span>
								<p class="rate mb-5">
									<span class="star">
										<i class="icon-star"></i>
										<i class="icon-star"></i>
								...
								<div class="d-md-flex mt-5 mb-5">
									<ul>
										<li><a href="#"><u>sushi</u></a></li>
										<li><a href="#"><u>Edamame</u></a></li>
										<li><a href="#"><u>sake</u></a></li>
										<li><a href="#"><u>lion</u></a></li>
										<li><a href="#"><u>king</u></a></li>
									</ul>
									<ul class="ml-md-5">
										<li><a href="#"><u>bento box</u></a></li>
										<li><a href="#"><u>assorted sushi</u></a></li>
										<li><a href="#"><u>assorted sashimi</u></a></li>
										<li><a href="#"><u>salmon skin</u></a></li>
										<li><a href="#"><u>poki salad</u></a></li>
									</ul>
								</div>
								<p>When she reached the first hills of the Italic Mountains, she had a last view back on the skyline of her hometown Bookmarksgrove, the headline of Alphabet Village and the subline of her own road, the Line Lane. Pityful a rethoric question ran over her cheek, then she continued her way.</p>
							</div>
          		...
          		<div class="col-md-12 hotel-single ftco-animate mb-5 mt-4">
					...
					<select class="selectpicker" >
						...
						<option>assorted sushi</option>
						<option>assorted sashimi</option>
						<option>salmon skin</option>
						<option>poki salad</option>						
